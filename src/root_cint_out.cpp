...
#define R__DICTIONARY_FILENAME dIhomedIwangyingdIdesktopdIab_softdIzhangrydIanalysiscode_version6_2dIJHS_ana_v06dIJHS_anadIsrcdIroot_cint_out
...
namespace ROOT {
   static void *new_entry_tm(void *p = nullptr);
   static void *newArray_entry_tm(Long_t size, void *p);
   static void delete_entry_tm(void *p);
   static void deleteArray_entry_tm(void *p);
   static void destruct_entry_tm(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::entry_tm*)
   {
      ::entry_tm *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::entry_tm >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("entry_tm", ::entry_tm::Class_Version(), "data_strcut_cint.h", 35,
                  typeid(::entry_tm), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::entry_tm::Dictionary, isa_proxy, 4,
                  sizeof(::entry_tm) );
      instance.SetNew(&new_entry_tm);
      instance.SetNewArray(&newArray_entry_tm);
      instance.SetDelete(&delete_entry_tm);
      instance.SetDeleteArray(&deleteArray_entry_tm);
      instance.SetDestructor(&destruct_entry_tm);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::entry_tm*)
   {
      return GenerateInitInstanceLocal(static_cast<::entry_tm*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::entry_tm*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT

namespace ROOT {
   static void *new_entry_strip(void *p = nullptr);
   static void *newArray_entry_strip(Long_t size, void *p);
   static void delete_entry_strip(void *p);
   static void deleteArray_entry_strip(void *p);
   static void destruct_entry_strip(void *p);

   // Function generating the singleton type initializer
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::entry_strip*)
   {
      ::entry_strip *ptr = nullptr;
      static ::TVirtualIsAProxy* isa_proxy = new ::TInstrumentedIsAProxy< ::entry_strip >(nullptr);
      static ::ROOT::TGenericClassInfo 
         instance("entry_strip", ::entry_strip::Class_Version(), "data_strcut_cint.h", 44,
                  typeid(::entry_strip), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &::entry_strip::Dictionary, isa_proxy, 4,
                  sizeof(::entry_strip) );
      instance.SetNew(&new_entry_strip);
      instance.SetNewArray(&newArray_entry_strip);
      instance.SetDelete(&delete_entry_strip);
      instance.SetDeleteArray(&deleteArray_entry_strip);
      instance.SetDestructor(&destruct_entry_strip);
      return &instance;
   }
   TGenericClassInfo *GenerateInitInstance(const ::entry_strip*)
   {
      return GenerateInitInstanceLocal(static_cast<::entry_strip*>(nullptr));
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal(static_cast<const ::entry_strip*>(nullptr)); R__UseDummy(_R__UNIQUE_DICT_(Init));
} // end of namespace ROOT
...
//______________________________________________________________________________
atomic_TClass_ptr entry_tm::fgIsA(nullptr);  // static to hold class pointer

//______________________________________________________________________________
const char *entry_tm::Class_Name()
{
   return "entry_tm";
}

//______________________________________________________________________________
const char *entry_tm::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::entry_tm*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int entry_tm::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::entry_tm*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *entry_tm::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::entry_tm*)nullptr)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *entry_tm::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::entry_tm*)nullptr)->GetClass(); }
   return fgIsA;
}

//______________________________________________________________________________
atomic_TClass_ptr entry_strip::fgIsA(nullptr);  // static to hold class pointer

//______________________________________________________________________________
const char *entry_strip::Class_Name()
{
   return "entry_strip";
}

//______________________________________________________________________________
const char *entry_strip::ImplFileName()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::entry_strip*)nullptr)->GetImplFileName();
}

//______________________________________________________________________________
int entry_strip::ImplFileLine()
{
   return ::ROOT::GenerateInitInstanceLocal((const ::entry_strip*)nullptr)->GetImplFileLine();
}

//______________________________________________________________________________
TClass *entry_strip::Dictionary()
{
   fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::entry_strip*)nullptr)->GetClass();
   return fgIsA;
}

//______________________________________________________________________________
TClass *entry_strip::Class()
{
   if (!fgIsA.load()) { R__LOCKGUARD(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::entry_strip*)nullptr)->GetClass(); }
   return fgIsA;
}
...
//______________________________________________________________________________
void entry_tm::Streamer(TBuffer &R__b)
{
   // Stream an object of class entry_tm.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(entry_tm::Class(),this);
   } else {
      R__b.WriteClassBuffer(entry_tm::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_entry_tm(void *p) {
      return  p ? new(p) ::entry_tm : new ::entry_tm;
   }
   static void *newArray_entry_tm(Long_t nElements, void *p) {
      return p ? new(p) ::entry_tm[nElements] : new ::entry_tm[nElements];
   }
   // Wrapper around operator delete
   static void delete_entry_tm(void *p) {
      delete (static_cast<::entry_tm*>(p));
   }
   static void deleteArray_entry_tm(void *p) {
      delete [] (static_cast<::entry_tm*>(p));
   }
   static void destruct_entry_tm(void *p) {
      typedef ::entry_tm current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::entry_tm

//______________________________________________________________________________
void entry_strip::Streamer(TBuffer &R__b)
{
   // Stream an object of class entry_strip.

   if (R__b.IsReading()) {
      R__b.ReadClassBuffer(entry_strip::Class(),this);
   } else {
      R__b.WriteClassBuffer(entry_strip::Class(),this);
   }
}

namespace ROOT {
   // Wrappers around operator new
   static void *new_entry_strip(void *p) {
      return  p ? new(p) ::entry_strip : new ::entry_strip;
   }
   static void *newArray_entry_strip(Long_t nElements, void *p) {
      return p ? new(p) ::entry_strip[nElements] : new ::entry_strip[nElements];
   }
   // Wrapper around operator delete
   static void delete_entry_strip(void *p) {
      delete (static_cast<::entry_strip*>(p));
   }
   static void deleteArray_entry_strip(void *p) {
      delete [] (static_cast<::entry_strip*>(p));
   }
   static void destruct_entry_strip(void *p) {
      typedef ::entry_strip current_t;
      (static_cast<current_t*>(p))->~current_t();
   }
} // end of namespace ROOT for class ::entry_strip
...
"/home/wangying/desktop/ab_soft/zhangry/analysiscode_version6_2/JHS_ana_v06/JHS_ana/inc",
"/home/wangying/software/root-6.30.04-build/include/",
"/home/wangying/Desktop/ab_soft/zhangry/analysiscode_version6_2/JHS_ana_v06/JHS_ana/build/",
nullptr
    };
...
struct __attribute__((annotate("$clingAutoload$data_strcut_cint.h")))  entry_tm;
struct __attribute__((annotate("$clingAutoload$data_strcut_cint.h")))  entry_strip;
)DICTFWDDCLS";
...
"entry_strip", payloadCode, "@",
"entry_tm", payloadCode, "@",
nullptr
};
